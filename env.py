...
class BoardEnv(Env):
    ...
    def reset(self):
        ...
        self.observation[food_pos] = CellTypes.FOOD    # food
        self.observation[water_pos] = CellTypes.WATER  # water
        # Place agent in an empty cell
        empty_cells = np.argwhere(self.observation == CellTypes.EMPTY)
        idx = np.random.choice(len(empty_cells))
        self.agent_position = tuple(empty_cells[idx])
        self.observation[self.agent_position] = CellTypes.AGENT
    ...
    def step(self, action):
        ...
        # Erase old position
        self.observation[self.agent_position] = CellTypes.EMPTY
        # Move agent to new position
        self.agent_position = new_position
        self.observation[self.agent_position] = CellTypes.AGENT
        self.done = True

        assert self.observation_space.contains(self.observation), "Observation contains invalid values!"
